...
void setup() {
  ...
  bump = new SoundFile(this, "bump1.wav");
  hit = new SoundFile(this, "explosion1.wav");
  paddleStrike = new SoundFile(this, "paddle.wav");
  pit = new SoundFile(this, "pit.wav");
